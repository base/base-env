...
utils.alias = function(env) {
  ...
  env.define('alias', {
    ...
    get: function() {
      ...
      var fn = env.instance.options.toAlias || env.instance.toAlias || env.toAlias || utils.identity;
      var name = path.basename(env.key);
      return alias || (alias = fn.call(env, name));
    }
  });
};
...
utils.namespace = function(env) {
  ...
  Object.defineProperty(env, 'namespace', {
    ...
    get: function() {
      var alias = namespace || env.alias;
      var parent = env.parent && env.parent.namespace;
